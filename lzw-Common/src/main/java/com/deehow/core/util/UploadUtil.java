...
import com.deehow.core.support.fastdfs.FileManager;
import com.deehow.core.support.fastdfs.FileModel;
import com.deehow.core.support.ftp.SftpClient;
import com.deehow.core.support.security.BASE64Decoder;
...
public final class UploadUtil {
	...
	/** 注意此方法读取文件，并不会立即释放资源，会等到gc时释放，所以这个方法适用于【经常被读取的小文件】 */
